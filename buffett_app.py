...
def plot_financials(df_2, x, y, x_cutoff, title):
    ...
    return st.bar_chart(data=df_subset.set_index(x)[y],x=None, y=None, color=None,width=0, height=300, use_container_width=True)
            ...
            with st.chat_message(message["role"]):
                ...
                with col1:
                    ...
                    if len(df_data.index) >2 & len(df_data.columns) == 2:
                        ...
                        with col2:
                            plot_financials(df_data,df_data.columns[0],df_data.columns[0], cutoff,title_name)
                    ...
                    if len(query_result) >= 1:
                      with st.chat_message("assistant"):
                        ...
                        if len(df_2.index) >2 & len(df_2.columns) == 2:
                            ...
                            with col2:                                  
                              plot_financials(df_2,df_2.columns[0],df_2.columns[0], cutoff,title_name)
